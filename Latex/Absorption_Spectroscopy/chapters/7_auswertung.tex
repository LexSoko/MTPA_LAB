...
To get the conversion efficiency $C$ first the fitting function of the SHG spectrum is integrated over the relevant interval around the peaks. 
...
\begin{align}
    ...
    CR &= (0.84 \pm 0.02)  \hspace{2pt} \% \hspace{3cm} CR \ldots \text{Conversion efficiency}
\end{align}
