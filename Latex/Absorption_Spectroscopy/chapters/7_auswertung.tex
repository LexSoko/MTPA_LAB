...
In order to obtain the central wavelength and the full width half maximum $FWHM$, the data in Table \ref{tab:execution:infrared-characterization} is fitted using the function \verb|curve_fit|.
